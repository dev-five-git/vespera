...
pub async fn generic_endpoint(vespera::axum::extract::Path(value): vespera::axum::extract::Path<String>) -> Json<GenericStruct<String>> {
    Json(GenericStruct { value, name: "John Doe".to_string() })
}

#[vespera::route(get, path = "/generic2")]
pub async fn generic_endpoint2() -> Json<GenericStruct<TestStruct>> {
    Json(GenericStruct { value: TestStruct { name: "test".to_string(), age: 20 }, name: "John Doe".to_string() })
}

#[vespera::route(get, path = "/generic3")]
pub async fn generic_endpoint3() -> Json<GenericStruct2<TestStruct, String>> {
    Json(GenericStruct2 { value: TestStruct { name: "test".to_string(), age: 20 }, value2: "test2".to_string(), name: "John Doe".to_string() })
}

#[vespera::route(get, path = "/generic4")]
pub async fn generic_endpoint4() -> Json<GenericStruct2<bool, bool>> {
    Json(GenericStruct2 { value: true, value2: false, name: "John Doe".to_string() })
}
